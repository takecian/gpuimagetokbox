...
- (void)sendAudioBuffer:(CMSampleBufferRef)audioBuffer block:(void (^)(CMSampleBufferRef))block;
{
    if (!isRecording)
    {
        return;
...
- (void)sendFrameAtTime:(CMTime)frameTime atIndex:(NSInteger)textureIndex block:(void (^)(CMSampleBufferRef))block;
{
    if (!isRecording)
    {
        [firstInputFramebuffer unlock];
